...
namespace Smartsheet.Api.Internal
{
    ...
    public class UserResourcesImpl : AbstractResources, UserResources
    {
        ...
        /// <exception cref="ServiceUnavailableException">Unexpected error on the server.</exception>
        /// <exception cref="SmartsheetException">If there is any other error during the operation.</exception>
        public virtual void ReactivateUser(long userId)
        {
            string path = $"users/{userId}/reactivate";
            this.CreateResource<object>(path, typeof(object), new { });
        }
        ...
        /// <exception cref="ServiceUnavailableException">Unexpected error on the server.</exception>
        /// <exception cref="SmartsheetException">If there is any other error during the operation.</exception>
        public virtual void DeactivateUser(long userId)
        {
            string path = $"users/{userId}/deactivate";
            this.CreateResource<object>(path, typeof(object), new { });
        }

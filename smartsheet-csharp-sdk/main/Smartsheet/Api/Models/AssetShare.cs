...
namespace Smartsheet.Api.Models
{
    ...
    public class AssetShare : NamedModel
    {
        ...
        public class CreateAssetShareBuilder
        {
            ...
            /// <returns> the share to one builder </returns>
            public CreateAssetShareBuilder SetSubject(string subject)
            {
            ...
            /// <returns> the share to one builder </returns>
            public CreateAssetShareBuilder SetMessage(string message)
            {
            ...
            /// <returns> the share to one builder </returns>
            public CreateAssetShareBuilder SetCcMe(bool? ccMe)
            {
                this.ccMe = ccMe;
                return this;
            }

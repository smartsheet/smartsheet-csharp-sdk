...
namespace Smartsheet.Api
{
    ...
    public interface UserResources
    {
        ...
        /// <returns>The upgraded <see cref="User"/> object.</returns>
        /// <exception cref="System.InvalidOperationException">If any argument is null or empty string.</exception>
        /// <exception cref="InvalidRequestException">If there is any problem with the REST API request.</exception>
        ...
        /// <exception cref="SmartsheetException">If there is any other error during the operation.</exception>
        RequestResult<object> UpgradeUserSeatType(long userId, long planId, string seatType);
        ...
        /// <exception cref="SmartsheetException">If there is any other error during the operation.</exception>
        RequestResult<object> DowngradeUserSeatType(long userId, long planId, string seatType);
